...
POINT_GROUP            PointGroups[]         = {
    ...
    {  "D4",    "(C4) 5*(C2) ",                                              is_true  },
    {  "D5",    "(C5) 5*(C2) ",                                              is_true  },
    {  "D6",    "(C6) (C3) 7*(C2) ",                                         is_true  },
    {  "D7",    "(C7) 7*(C2) ",                                              is_true  },
    {  "D8",    "(C8) (C4) 9*(C2) ",                                         is_true  },
    {  "C2v",   "(C2) 2*(sigma) ",                                           is_true  },
    {  "C3v",   "(C3) 3*(sigma) ",                                           is_true  },
    {  "C4v",   "(C4) (C2) 4*(sigma) ",                                      is_true  },
    {  "C5v",   "(C5) 5*(sigma) ",                                           is_true  },
    {  "C6v",   "(C6) (C3) (C2) 6*(sigma) ",                                 is_true  },
    {  "C7v",   "(C7) 7*(sigma) ",                                           is_true  },
    {  "C8v",   "(C8) (C4) (C2) 8*(sigma) ",                                 is_true  },
    {  "C2h",   "(i) (C2) (sigma) ",                                         is_true  },
    {  "C3h",   "(C3) (S3) (sigma) ",                                        is_true  },
    {  "C4h",   "(i) (C4) (C2) (S4) (sigma) ",                               is_true  },
    {  "C5h",   "(C5) (S5) (sigma) ",                                        is_true  },
    {  "C6h",   "(i) (C6) (C3) (C2) (S6) (S3) (sigma) ",                     is_true  },
    {  "C7h",   "(C7) (S7) (sigma) ",                                        is_true  },
    {  "C8h",   "(i) (C8) (C4) (C2) (S8) (S4) (sigma) ",                     is_true  },
    {  "D2h",   "(i) 3*(C2) 3*(sigma) ",                                     is_true  },
    {  "D3h",   "(C3) 3*(C2) (S3) 4*(sigma) ",                               is_true  },
    {  "D4h",   "(i) (C4) 5*(C2) (S4) 5*(sigma) ",                           is_true  },
    {  "D5h",   "(C5) 5*(C2) (S5) 6*(sigma) ",                               is_true  },
    {  "D6h",   "(i) (C6) (C3) 7*(C2) (S6) (S3) 7*(sigma) ",                 is_true  },
    {  "D7h",   "(C7) 7*(C2) (S7) 8*(sigma) ",                               is_true  },
    {  "D8h",   "(i) (C8) (C4) 9*(C2) (S8) (S4) 9*(sigma) ",                 is_true  },
    {  "D2d",   "3*(C2) (S4) 2*(sigma) ",                                    is_true  },
    {  "D3d",   "(i) (C3) 3*(C2) (S6) 3*(sigma) ",                           is_true  },
    {  "D4d",   "(C4) 5*(C2) (S8) 4*(sigma) ",                               is_true  },
    {  "D5d",   "(i) (C5) 5*(C2) (S10) 5*(sigma) ",                          is_true  },
    {  "D6d",   "(C6) (C3) 7*(C2) (S12) (S4) 6*(sigma) ",                    is_true  },
    {  "D7d",   "(i) (C7) 7*(C2) (S14) 7*(sigma) ",                          is_true  },
    {  "D8d",   "(C8) (C4) 9*(C2) (S16) 8*(sigma) ",                         is_true  },
    {  "S4",    "(C2) (S4) ",                                                is_true  },
    {  "S6",    "(i) (C3) (S6) ",                                            is_true  },
    {  "S8",    "(C4) (C2) (S8) ",                                           is_true  },
    {  "T",     "4*(C3) 3*(C2) ",                                            is_true  },
    {  "Th",    "(i) 4*(C3) 3*(C2) 4*(S6) 3*(sigma) ",                       is_true  },
    {  "Td",    "4*(C3) 3*(C2) 3*(S4) 6*(sigma) ",                           is_true  },
    {  "O",     "3*(C4) 4*(C3) 9*(C2) ",                                     is_true  },
    {  "Oh",    "(i) 3*(C4) 4*(C3) 9*(C2) 4*(S6) 3*(S4) 9*(sigma) ",         is_true  },
    {  "Cinfv", "(Cinf) (sigma) ",                                           is_true  },
    {  "Dinfh", "(i) (Cinf) (C2) 2*(sigma) ",                                is_true  },
    {  "I",     "6*(C5) 10*(C3) 15*(C2) ",                                   is_true  },
    {  "Ih",    "(i) 6*(C5) 10*(C3) 15*(C2) 6*(S10) 10*(S6) 15*(sigma) ",    is_true  },
    {  "Kh",    "(i) (Cinf) (sigma) ",                                       is_true  },
    } ;
